			...
			<div id="containerx">
				<div class="contents">
					...
					<table class="order_tbl mt10" cellspacing="0" border="1"
						...
						<thead>
							<tr>
								<th class="order_amount" scope="col"><label
									class="order_chk_type"> <input type="checkbox"
										id="chkall" data-flg="Y"> <!--체크박스선택시--> <span
										class="order_clicked_deal"> <i class="blind">상품 전체
												선택</i>
									</span> <!--//체크박스선택시-->
								</label></th>
								<th class="order_amount" colspan="2">
									<div class="cart_chk_wrap">
										<span class="cart_chk"> <a class="cart_btn_select"
											onclick="$.cartDel();">선택 상품 삭제</a>
										</span> 상품 정보
									</div>
								</th>
					...
					<!---- block 다신 묶음 상품 ------------------------------------>
					<table class="order_tbl mt10" cellspacing="0" border="1"
						summary="주문 리스트" id="DSShopBundleDiv" data-basedeliveryfee="3000"
						data-freedeliveryfee="30000">
						<caption>주문 리스트</caption>
						<colgroup>
							<col width="50">
							<col width="120">
						...
						<!-- 개별 상품 시작 -->
						<tbody>
							<tr id="cartgoods7891782" data-cartidx="7891782"
								data-goodsidx="11379" data-activeyn="Y" data-delivtype="P"
								data-delivfee="3000" data-delivcon="30000" data-setyn="N">
								<td valign="top" align="center"><label
									class="order_chk_type"> <input type="checkbox"
										checked="checked" id="chko7891782" data-flg="Y"
										data-bundledeliv="0" data-reservd="N"> <!--체크박스선택시-->
										<span class="order_clicked_deal"> <i class="blind">상품 전체 선택</i></span> <!--//체크박스선택시-->
								</label></td>
								<td class="order_thmb"><a href="/goods/view.asp?g=11379"
									onclick="hitRecentLog('11379');"> <img alt="temp thmb"
										src="http://data.0app0.com/diet/shop/goods/20190528/m_20190528152633_1478357212.jpg">
								</a></td>
								<td class="order_info2" colspan="3"><a class="order_deal"
									title="" href="/goods/view.asp?g=11379">상품명1</a>
									<p class="order_deal_info">상품 설명</p> <!-- 옵션명 노출-->
									<ul class="order_option_area">
										<!-- 상품 옵션 시작 -->
										<li id="cartop6681" data-optidx="6681" data-activeyn="Y"
											data-mlgyn="N"><span class="order_option2"><span
											class="order_option_cnt inpspan" data-count="1"> <span
												class="order_option_input"> <span class="cart_choice"><a
														class="mius" id="minbtn" onclick="$.mnsGoods(6681);">-</a><span
														class="price" id="curcnt"><span
															class="price_input2"><input type="number"
																value="1" class="inputno2" style="outline: none;"
																oninput="this.value=this.value.slice(0,this.maxLength)"
																maxlength="4" data-idx="6681" data-uc="50"></span></span> <a
														class="plus" id="plsbtn" onclick="$.plsGoods(6681);">+</a></span>
											</span>
										</span> <span class="order_option_amounts2" data-price="TKDVNA">
							...
							<!-- 개별 상품 시작 -->
							<tr id="cartgoods7891780" data-cartidx="7891780"
								data-goodsidx="12463" data-activeyn="Y" data-delivtype="P"
								data-delivfee="3000" data-delivcon="30000" data-setyn="N">
								<td valign="top" align="center"><label
									class="order_chk_type"> <input type="checkbox"
										checked="checked" id="chko7891780" data-flg="Y"
										data-bundledeliv="0" data-reservd="N"> <!--체크박스선택시-->
										<span class="order_clicked_deal"> <i class="blind">상품
												전체 선택</i>
									</span> <!--//체크박스선택시-->
								</label></td>
								<td class="order_thmb"><a href="/goods/view.asp?g=12463"
									onclick="hitRecentLog('12463');"> <img alt="temp thmb"
										src="http://data.0app0.com/diet/shop/goods/20190821/m_20190821180323_9245827117.jpg">
								</a></td>
								<td class="order_info2" colspan="3"><a class="order_deal"
									title="" href="/goods/view.asp?g=12463">상품명2</a>
									<p class="order_deal_info">상품 설명2</p> <!-- 옵션명 노출-->
									<ul class="order_option_area">
										<!-- 상품 옵션 시작 -->
										<li id="cartop11188" data-optidx="11188" data-activeyn="Y"
											data-mlgyn="N">
											<span class="order_option_cnt inpspan" data-count="1"> <span
												class="order_option_input"> <span class="cart_choice"><a
														class="mius" id="minbtn" onclick="$.mnsGoods(11188);">-</a><span
														class="price" id="curcnt"><span
															class="price_input2"><input type="number"
																value="1" class="inputno2" style="outline: none;"
																oninput="this.value=this.value.slice(0,this.maxLength)"
																maxlength="4" data-idx="11188" data-uc="1"></span></span> <a
														class="plus" id="plsbtn" onclick="$.plsGoods(11188);">+</a></span>
											</span>
										</span> <span class="order_option_amounts2" data-price="23900">
												<em class="b">상품2 가격</em>원
										</span><span><a href="javascript:$.optDel(11188);"
												class="cart_btn_del"></a> </span></li>
							...
							<tr>
								<td colspan="5">
									<div class="cart_ds" style="margin: -21px 0 -20px 0">
										...
										<p>
											<em class="cart_txt cart_fcT1"><i class="fa fa-truck"
												style="font-size: 17px;"></i> 미진배송 (일반식품)</em><a
				...
				<br><br>
					...
					<div class="order_calculate_area mt80">
						...
						<div class="order_deal_payment">
							...
							<div class="order_result_area" id="totalprice"
								data-totalprice="63800">
					...
					<div class="order_btn_section">
						<span class="order_btn_box"><a
							href="javascript:$.OrderIn();" class="order_btn_ok">구매하기</a><a
							href="/main.asp" class="order_btn_cancel ml20">계속 쇼핑하기</a></span>
