	...
	<div class="centerText">
		<form action="minsert.do" method="post" id="joinForm">
			<table class="type02" cellspacing="5">
				...
				<tr>
					<th scope="row">성별</th>
					<td><input id="genderM" type="radio" name="gender" value="남"
						style="width: 20px; height: 20px;" requi#f53f29> <label
						for="genderM">남</label> <input id="genderY" type="radio"
						name="gender" value="여" style="width: 20px; height: 20px;"
						requi#f53f29> <label for="genderY">여</label></td>
				</tr>
				<tr>
					...
					<input type = "text" id = "DOB" maxlength="8" name="birthday" style="width: 159px; margin-left: 0px;" requi#f53f29; hidden>

				</tr>
				<tr>
					<th scope="row">전화번호</th>

					<td><input type="tel" name="phone" id="phone" requi#f53f29>
						<div id="checkPhone" class="checkInfo" style="font-size: 0.8em"></div></td>
				</tr>
				<tr>
					<th scope="row">이메일</th>
					<td id="emailPt"><input id="email" type="text" name="email"
	...
	<script>
		...
		$("#phone").keyup(function() {
			...
			if (phone == "") {
				...
				$("#phone").css("border", "2px solid #f53f29");
